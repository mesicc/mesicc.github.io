...
const i18n = {
  en: {
    ...
    bioText:        `I'm a Web Developer and Software Development student at the <a href="https://etf.unsa.ba" target="_blank" class="bio-highlight">Faculty of Electrical Engineering, University of Sarajevo</a>. I build fast, visually polished web applications using modern technologies — with a strong focus on performance, clean code, SEO optimization, and reliable deployment. Every project I take on is crafted with precision, purpose, and a commitment to delivering real results. <br> Whether it's a business website, a booking platform, or a custom web app — I bring the same level of dedication and technical depth to every build. From the first line of code to final deployment, I make sure everything works flawlessly.`,
    eduLabel:       'Education',
  ...
  bs: {
    ...
    aboutTitleGrad: 'Me',
    bioRole:        'Web Developer',
    bioText:        `Ja sam Web Developer i student Razvoja Softvera na <a href="https://etf.unsa.ba" target="_blank" class="bio-highlight">Elektrotehničkom fakultetu Univerziteta u Sarajevu</a>. Izrađujem brze, vizualno dotjerane web aplikacije koristeći moderne tehnologije — s posebnim fokusom na performanse, čist kod, SEO optimizaciju i pouzdano postavljanje aplikacija. Svaki projekat pristupam s preciznošću, svrhom i posvećenošću isporuci pravih rezultata. <br> Bilo da se radi o poslovnoj web stranici, platformi za rezervacije ili custom web aplikaciji — pristupam svakom projektu s jednakim nivoom posvećenosti i tehničke dubine. Od prve linije koda do finalnog postavljanja, osiguravam da sve radi besprijekorno.`,
